...
def get_gigachat_key():
    """
    Берём личный ключ пользователя.
    Если пользователь его не вводил — используем общий ключ приложения.
    """
...
class AIAssistantPage(tk.Frame):
    ...
    def refresh(self):
        """Вызывается при переключении на страницу – обновляем приветствие, если ключ появился."""
        self._clear_chat()